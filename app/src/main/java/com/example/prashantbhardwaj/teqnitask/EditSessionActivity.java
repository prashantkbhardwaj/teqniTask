...
public class EditSessionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spLevel1Opt = (Spinner) findViewById(R.id.spLevel1OptU);
        spLevel2Opt = (Spinner) findViewById(R.id.spLevel2OptU);
        ...
        bEditSession.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(EditSessionActivity.this,error.getMessage().toString(),Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showJSON(String response){
        ...
        for (int i = 0; i < level1List.length; i++){
            if (level1List[i].equals(getIntent().getExtras().get("level1").toString())){
                spLevel1Opt.setSelection(i);
            }
        }
    ...
    private void updateSession(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.EDIT_SESSION_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        Intent intent = new Intent(EditSessionActivity.this, TeacherActivity.class);
                        EditSessionActivity.this.startActivity(intent);
                        Toast.makeText(EditSessionActivity.this, "Successfully Updated" , Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        //Showing toast
                        Toast.makeText(EditSessionActivity.this, volleyError.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
